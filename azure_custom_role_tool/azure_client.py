...
class AzureClient:
    ...
    def __init__(self, subscription_id: Optional[str] = None):
        ...
        if not self.subscription_id:
            raise ValueError(
                "AZURE_SUBSCRIPTION_ID not set in environment or parameters"
            )
    ...
    def list_custom_roles(self, scope: str = None) -> List[Dict]:
        ...
        try:
            ...
            for r in roles:
                ...
                is_custom = r.type == "CustomRole" or (
            ...
            return [
                {
                    "id": r.id,
                    "name": r.role_name
                    or r.name,  # role_name is the display name, fallback to name if not available
    ...
    def create_custom_role(self, role_def: AzureRoleDefinition) -> Dict:
        ...
        try:
            ...
            return {
                ...
                "type": created.type,
                "permissions": [
                    self._permission_to_dict(p) for p in created.permissions
                ],
    ...
    def update_custom_role(self, role_id: str, role_def: AzureRoleDefinition) -> Dict:
        ...
        try:
            ...
            return {
                ...
                "type": updated.type,
                "permissions": [
                    self._permission_to_dict(p) for p in updated.permissions
                ],
